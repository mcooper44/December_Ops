...
from create_codes import create_bc
...
ALL_IN_ONE = ['Possibilities International', 'Cambridge Fire Fighters','SPONSOR - REITZEL']
...
if __name__ == '__main__':
    ...
    if the_date:
        ...
        for hh in dhc.key_iter():
            ...
            # THE SERVICE PROVIDER TRANSLATED INTO A MORE PUBLIC LEGIBLE
            # VERSION.  THIS WILL THEN BE FED INTO A LOOKUP TABLE IN THE
            # CONFIRMATION LETTER FILE TO DERIVE THE ACTUAL ADDRESS
